...
const GroupReport = lazy(() => import('./features/reporting/GroupReport'));
  ...
  const categories = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Loan Account Enquires', to: '/loan/account-enquires', icon: ManageSearchRoundedIcon },
        { label: 'Loan Charge off', to: '/loan/change-off', icon: BlockRoundedIcon },
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'GL Account Edit', to: '/accounting/account-edit', icon: ManageSearchRoundedIcon },
        { label: 'GL Account Opening', to: '/accounting/account-opening', icon: AddCircleRoundedIcon },
              ...
              <main className="main-content">
                <Suspense fallback={pageLoader}>
                  <Routes>
                    ...
                    <Route path="/loan/account-enquires" element={renderWithAccess('loan', <LoanAccountEnquires user={user} />)} />
                    <Route
                    ...
                    />
                    <Route
                      path="/reporting/loan-balance"
                      element={renderWithAccess('reporting', <LoanBalance />)}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="/reporting/group-report"
                      element={renderWithAccess('reporting', <GroupReport />)}
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={renderWithAccess('reporting', <LoanProvision />)}
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={renderWithAccess('reporting', <DetailedJournalReport />)}
                    />
                    <Route
                      path="/reporting/loan-reports"
                      element={renderWithAccess('reporting', <LoanReports />)}
                    />
                    <Route
