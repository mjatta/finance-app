...
const memberCards = [
  ...
  { title: 'Transfer', description: 'Transfer funds between accounts', path: '/member/transfer', icon: SwapHorizRoundedIcon, color: '#06b6d4', bgGradient: 'linear-gradient(135deg, rgba(6, 182, 212, 0.1) 0%, rgba(6, 182, 212, 0.05) 100%)' },
